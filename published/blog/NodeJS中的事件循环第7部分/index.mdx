...
title: "NodeJS 中的事件循环 第7部分"
subtitle: "JavaScript 事件循环 vs NodeJS 事件循环"
tags: ["NodeJS", "事件循环", "JavaScript"]
summary: ""
series: "NodeJSEventLoopOnMediumByDeepalJayasekara"
---
...
<!-- prettier-ignore -->
<a target="_blank" href="https://html.spec.whatwg.org/">HTML5 规范</a>描述了一个规范集合，第三方可遵循这些规范来开发浏览器、JS运行环境或是其他相关的库。同样还描述了实现事件循环模型的指南，以及其他可能与事件循环有关的 JS 特性，如 timer。
