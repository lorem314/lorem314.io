...
<div class="custom-code-title">例子 2-1 使用 NodeJS 发送 HTTP 请求</div>
...
<div class="custom-code-title">实例2-4 server-gzip.js</div>
...
<div class="custom-code-title">示例 2-5 比较压缩和未压缩的请求</div>
...
<blockquote>
  <code class="language-text">wc</code> 命令用于计算字数，由 <u>w</u>ord{" "}
  <u>c</u>ount 取首字母得来。<code class="language-text">-c</code>
  代表计算字节数。
</blockquote>

未压缩版本的文件大小为 40 字节，压缩版本的文件大小为 53 字节。

对于较大的文档，这不成问题。为了证明这一点，将前面的 echo 命令再运行 3 次以增加 index.html 文件的大小。然后，再次运行示例 2-5 中的相同命令。 这次未压缩版本为 160 字节，压缩版本为 56 字节。这是因为 gzip 通过删除响应正文中的冗余来运行，并且该示例包含重复四次的相同文本。如果响应正文包含冗余文本（例如具有重复属性名称的 JSON 文档），这种冗余删除特别有用。大多数 gzip 压缩工具也可以配置为当文档小于特定大小时不启用压缩。
...
<div class="custom-code-title">示例 2-6 生成自签名证书</div>
...
<div class="custom-code-title">示例 2-7 recipe-api/producer-https-basic.js</div>
...
<div class="custom-code-title">示例 2-8 web-api/consumer-https-basic.js</div>
...
<div class="custom-code-title">示例 2-9 如何成为自己的证书颁发机构</div>
...
<div class="custom-code-title">示例 2-10 shared/graphql-schema.gql</div>
...
<div class="custom-code-title">表 2-3 GraphQL中的变量</div>
...
<div class="custom-code-title">示例 2-11 recipe-api/producer-graphql.js</div>
...
<div class="custom-code-title">示例 2-12 web-api/consumer-graphql.js</div>
...
<div class="custom-code-title">示例 2-13 shared/grpc-recipe.proto</div>
...
<div class="custom-code-title">表 2-14 Common gRPC scalars</div>
...
<div class="custom-code-title">示例 2-14 recipe-api/producer-grpc.js</div>
...
<div class="custom-code-title">示例 2-15 web-api/consumer-grpc.js</div>
