...
<Table id="1-4" title="电话簿（第 3 版本）">
  ...
  <Tbody>
    ...
    <Tr tds={["2", "Mike", "555-222-2345", "30062"]} />
    <Tr tds={["3", "Jenny", "555-334-3411", "01209"]} />
    <Tr tds={["3", "Jenny", "555-333-3456", "01209"]} />
  </Tbody>
</Table>
...
FROM contacts LEFT JOIN numbers ON contacts.contact_id=numbers.contact_id
WHERE contacts.contact_id=3;
```

该查询的结果如表格 1-7 所示。

<Table id="1-7" title="JOIN 查询结果">
...
<Figure id="figure_1-1" title="图片 1-1 硬盘查找 VS 连续访问">

![图片 1-1 硬盘查找 VS 连续访问](./figure_1-1.png)
